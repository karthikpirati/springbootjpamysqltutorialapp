package com.springboot.SpringBootProject.files.controller;
...
import com.springboot.SpringBootProject.files.repository.FileRepository;
...
public class FileController {
	...
	@Autowired FileRepository imageRepository;
	@PostMapping("/upload")
